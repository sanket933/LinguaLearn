        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-4 max-w-md">
              Master new languages with interactive lessons, personalized practice, and AI-powered feedback. 
              Join millions of learners worldwide on their language learning journey.
            </p>
