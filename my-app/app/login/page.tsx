    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900">
        <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg w-full max-w-md text-center">
          <h1 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white">Welcome!</h1>
          <p className="mb-4 text-gray-700 dark:text-gray-200">You are logged in as <span className="font-semibold">{email}</span></p>
          <button
